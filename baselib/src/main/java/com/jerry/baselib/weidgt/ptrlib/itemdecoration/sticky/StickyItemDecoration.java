...
public class StickyItemDecoration extends RecyclerView.ItemDecoration {
    ...
    protected static final int TYPE_STICKY_HEAD = 1;
    ...
    public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if (mEnableStickyHead && mFirstVisiblePosition >= mStickyHeadPosition && mStickyHeadPosition != -1) {
            View belowView = parent.findChildViewUnder(c.getWidth() >> 1, mStickyHeadContainer.getChildHeight() + 0.01f);

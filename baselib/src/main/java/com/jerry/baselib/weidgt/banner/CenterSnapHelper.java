...
public class CenterSnapHelper extends OnFlingListener {
    ...
    private final RecyclerView.OnScrollListener mScrollListener = new RecyclerView.OnScrollListener() {
        ...
        public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
            ...
            final BannerLayoutManager layoutManager = (BannerLayoutManager) recyclerView.getLayoutManager();
            final BannerLayoutManager.OnPageChangeListener onPageChangeListener = layoutManager.onPageChangeListener;
    ...
    public boolean onFling(int velocityX, int velocityY) {
        ...
        if (!layoutManager.getInfinite() &&
            (layoutManager.mOffset == layoutManager.getMaxOffset() || layoutManager.mOffset == layoutManager.getMinOffset())) {
            return false;
        }
        ...
        if (layoutManager.mOrientation == BannerLayoutManager.VERTICAL && Math.abs(velocityY) > minFlingVelocity) {
            ...
            mRecyclerView.smoothScrollToPosition(layoutManager.getReverseLayout() ? currentPosition - finalOffset : currentPosition + finalOffset);
            return true;
        }
     ...
     * RecyclerView.
     * @throws IllegalArgumentException if there is already a {@link OnFlingListener}

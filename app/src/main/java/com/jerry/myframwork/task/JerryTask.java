package com.jerry.myframwork.task;
...
import com.jerry.myframwork.helper.WeakHandler;
 ...
 * @Description 异步任务库
 */
public class JerryTask implements LifecycleObserver {
    ...
    private static JerryTask getInstance() {
    ...
    private static class DzcjTaskHolder {
        ...
        static final JerryTask INSTANCE = new JerryTask();
    }
